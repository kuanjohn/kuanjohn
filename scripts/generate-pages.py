...
<section class="section-pad"><div class="container-max grid gap-12 lg:grid-cols-2">
  ...
  <div class="glass-card p-6"><p class="eyebrow">Leadership philosophy</p><p class="mt-3 text-fg/65">Outcomes over activity. Enable partners. Coach teams. Tell the truth about risk. Celebrate measurable wins.</p></div></div>
</div></section>
<section class="section-pad border-t border-line/5"><div class="container-max">
